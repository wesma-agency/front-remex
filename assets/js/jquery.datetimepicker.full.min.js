  ...
  (D = function (e, t) {
    ...
    (r = function (e) {
      ...
      for (e = e || {}, t = 1; t < arguments.length; t++)
        if ((a = arguments[t])) for (var n in a) a.hasOwnProperty(n) && ("object" == typeof a[n] ? r(e[n], a[n]) : (e[n] = a[n]));
      return e;
    }),
    (a = function (e, t) {
              ...
              (0 < a && "\\" === t.charAt(a - 1)
                ...
                : ((o = this.parseFormat(i, e)),
                  a !== r - 1 &&
                    ...
                    "S" === t.charAt(a + 1) &&
                    ((n = parseInt(o) || 0), (o += this.dateSettings.ordinal(n))),
                  (s += o)));
          return s;
        }
        return "";
              ...
              "string" === L.type(m.mask) &&
                ...
                O.on("keydown.xdsoft", function (e) {
                  ...
                  if ((48 <= n && n <= 57) || (96 <= n && n <= 105) || 8 === n || 46 === n) {
                    for (
                      t = 8 === n || 46 === n ? "_" : String.fromCharCode(96 <= n && n <= 105 ? n - 48 : n), 8 === n && r && !i && (r -= 1);
                      ;
          ...
          F.find(".xdsoft_select")
            ...
            .on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
              if (!this.touchMoved) {
                ...
                W &&
                  W.currentTime &&
                  W.currentTime[L(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](
                    L(this).data("value")
                  ),
            ...
            (_.setOptions = function (e) {
              ...
              (I = L.extend(!0, {}, I, e)),
                ...
                e.allowDateRe &&
                  "[object String]" === Object.prototype.toString.call(e.allowDateRe) &&
                ...
                e.highlightedDates &&
                  ...
                  (L.each(e.highlightedDates, function (e, t) {
                    ...
                    void 0 !== l[o]
                      ? (a = l[o].desc) && a.length && r.desc && r.desc.length && (l[o].desc = a + "\n" + r.desc)
                      : (l[o] = r);
                  }),
                  ...
                  L.each(e.highlightedPeriods, function (e, t) {
                    ...
                    for (; a <= n; )
                      (o = new m(a, r, d)),
                        ...
                        void 0 !== l[i]
                          ? (s = l[i].desc) && s.length && o.desc && o.desc.length && (l[i].desc = s + "\n" + o.desc)
                          : (l[i] = o);
                  }),
                  (I.highlightedDates = L.extend(!0, [], l))),
                e.disabledDates &&
                ...
                I.minDateTime &&
                  /^\+(.*)$/.test(I.minDateTime) &&
                  (I.minDateTime = W.strToDateTime(I.minDateTime).dateFormat(I.formatDate)),
                I.maxDateTime &&
                  /^\+(.*)$/.test(I.maxDateTime) &&
                  (I.maxDateTime = W.strToDateTime(I.maxDateTime).dateFormat(I.formatDate)),
                  ...
                  O.off("blur.xdsoft").on("blur.xdsoft", function () {
                    if (
                      ...
                      (!L.trim(L(this).val()).length ||
                        ("string" == typeof I.mask && L.trim(L(this).val()) === I.mask.replace(/[0-9]/g, "_")))
                    )
            ...
            (W = new (function () {
              ...
              (r.now = function (e) {
                ...
                (r.getWeekOfYear = function (e) {
                  ...
                  return (
                    4 !== a.getDay() && a.setMonth(0, 1 + ((4 - a.getDay() + 7) % 7)), Math.ceil(((e - a) / 864e5 + a.getDay() + 1) / 7)
                  );
                }),
                (r.strToDateTime = function (e) {
                  ...
                  return e && e instanceof Date && r.isValidDate(e)
                    ...
                    : ((n = /^([+-]{1})(.*)$/.exec(e)) && (n[2] = E.parseDate(n[2], I.formatDate)),
                      (a =
                        n && n[2]
                          ? ((t = n[2].getTime() - 6e4 * n[2].getTimezoneOffset()),
                            new Date(r.now(!0).getTime() + parseInt(n[1] + "1", 10) * t))
                          : e
                ...
                (r.str = function () {
                  ...
                  return (
                    I.yearOffset &&
                      (e = (e = e.replace("Y", r.currentTime.getFullYear() + I.yearOffset)).replace(
                        "y",
                        String(r.currentTime.getFullYear() + I.yearOffset).substring(2, 4)
                      )),
              ...
              .on("dblclick.xdsoft", function () {
                ...
                (a = new Date(a.getFullYear(), a.getMonth(), a.getDate())),
                  ...
                  a < (e = new Date(e.getFullYear(), e.getMonth(), e.getDate())) ||
                    ...
                    (t = new Date(t.getFullYear(), t.getMonth(), t.getDate())) < a ||
                      (O.val(W.str()), O.trigger("change"), _.trigger("close.xdsoft")));
              }),
            ...
            o.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function () {
              ...
              !(function e(t) {
                ...
                r < I.timeHeightInTimePicker
                  ? (r = I.timeHeightInTimePicker)
                  : o.hasClass(I.next) && n - a < r && P.css("marginTop", "-" + n + "px"),
                  o.hasClass(I.next) && r < n - a
            ...
            _.on("xchange.xdsoft", function (e) {
                ...
                (t = setTimeout(function () {
                  ...
                  for (
                    var e,
                      ...
                      u,
                      l = "",
                      f = new Date(W.currentTime.getFullYear(), W.currentTime.getMonth(), 1, 12, 0, 0),
                      c = 0,
                      m = W.now(),
                      h = !1,
                      g = !1,
                  ...
                  for (l += "<table><thead><tr>", I.weeks && (l += "<th></th>"), e = 0; e < 7; e += 1)
                    l += "<th>" + I.i18n[R].dayOfWeekShort[(e + I.dayOfWeekStart) % 7] + "</th>";
                  for (
                    l += "</tr></thead>",
                      l += "<tbody>",
                      !1 !== I.maxDate &&
                        ((h = W.strToDate(I.maxDate)), (h = new Date(h.getFullYear(), h.getMonth(), h.getDate(), 23, 59, 59, 999))),
                    ...
                    (y = []),
                      ...
                      I.allowDateRe &&
                        "[object RegExp]" === Object.prototype.toString.call(I.allowDateRe) &&
                        (I.allowDateRe.test(E.formatDate(f, I.formatDate)) || y.push("xdsoft_disabled")),
                      I.allowDates &&
                        0 < I.allowDates.length &&
                        -1 === I.allowDates.indexOf(E.formatDate(f, I.formatDate)) &&
                        y.push("xdsoft_disabled");
                    var b = 31 * (12 * f.getFullYear() + f.getMonth()) + f.getDate();
                    ((!1 !== h && h < f) || (!1 !== p && f < p) || (!1 !== g && f < g) || (!1 !== D && u < b) || (i && !1 === i[0])) &&
                      y.push("xdsoft_disabled"),
                      ...
                      (I.defaultSelect || _.data("changed")) &&
                        E.formatDate(W.currentTime, I.formatDate) === E.formatDate(f, I.formatDate) &&
                        y.push("xdsoft_current"),
                      E.formatDate(m, I.formatDate) === E.formatDate(f, I.formatDate) && y.push("xdsoft_today"),
                      (0 !== f.getDay() && 6 !== f.getDay() && -1 === I.weekends.indexOf(E.formatDate(f, I.formatDate))) ||
                        y.push("xdsoft_weekend"),
                      void 0 !== I.highlightedDates[E.formatDate(f, I.formatDate)] &&
                        ((t = I.highlightedDates[E.formatDate(f, I.formatDate)]),
                  ...
                  for (P.html(k), H = "", c = parseInt(I.yearStart, 10); c <= parseInt(I.yearEnd, 10); c += 1)
                    H +=
                      '<div class="xdsoft_option ' +
                      (W.currentTime.getFullYear() === c ? "xdsoft_current" : "") +
                      '" data-value="' +
                      c +
                      '">' +
                      (c + I.yearOffset) +
              ...
              I.timepicker &&
                (P.find(".xdsoft_current").length
                  ? (e = ".xdsoft_current")
                  : P.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"),
                e
                  ? ((t = u[0].clientHeight),
                    (a = P[0].offsetHeight) - t < (n = P.find(e).index() * I.timeHeightInTimePicker + 1) && (n = a - t),
                    u.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (a - t)]))
            ...
            C.on("touchend click.xdsoft", "td", function (e) {
              ...
              a.setDate(1),
                ...
                (1 < n || !0 === I.closeOnDateSelect || (!1 === I.closeOnDateSelect && !I.timepicker)) &&
                  !I.inline &&
            ...
            O.on("mousewheel.xdsoft", function (e) {
              return (
                ...
                (!I.datepicker && I.timepicker
                  ? (0 <= (a = P.find(".xdsoft_current").length ? P.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY &&
              ...
              "rtl" === s.parent().css("direction") && (n -= _.outerWidth() - s.outerWidth()),
                I.fixed
                  ...
                  : ((i = !1),
                    h(t, function (e) {
                      return (
                        null !== e && ("fixed" === I.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(i = !0) : void 0)
                      );
                    }),
                    i && !I.insideParent
                      ? ((r = "fixed"), a + _.outerHeight() > f + c ? ((u = "bottom"), (a = f + c - e.top)) : (a -= c))
                      : a + _[0].offsetHeight > f + c && (a = e.top - _[0].offsetHeight + 1),
                    a < 0 && (a = 0),
            ...
            O.data("xdsoft_datetimepicker", _)
              ...
              .on("keydown.xdsoft", function (e) {
                ...
                return -1 !== [D].indexOf(a) && I.enterLikeTab
                  ? ((t = L("input:visible,textarea:visible,button:visible,a:visible")),
                    _.trigger("close.xdsoft"),
